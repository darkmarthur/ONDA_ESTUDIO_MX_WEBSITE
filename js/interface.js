(function ($) {
  ...
  /* ondavisual carousel */
  if ($(".ondavisual-carousel").length) {
    $(".ondavisual-carousel").owlCarousel({
      margin: 10,
      loop: true,
      margin: 0,
      nav: true,
  ...
  /* ondasonora carousel */
  if ($(".ondasonora-carousel").length) {
    $(".ondasonora-carousel").owlCarousel({
      margin: 10,
      loop: true,
      margin: 0,
      nav: true,
  ...
  if ($(".ondaconceptual-carousel").length) {
    $(".ondaconceptual-carousel").owlCarousel({
      margin: 10,
      loop: true,
      margin: 0,
      nav: true,
